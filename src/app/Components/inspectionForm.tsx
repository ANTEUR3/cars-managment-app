...
const InspectionForm = ({visible,setVisible}:{visible:boolean,setVisible:any} ) => {
...
const [faultNumber,setFaultNumber]=useState<number>(0)
    ...
    const addFault=()=>{
        ...
        cancel.className='text-white bg-red-500 px-2 py-1 rounded-lg cursor-pointer hover:scale-105 '
    ...
    return (
        ...
        <div className="w-full max-w-md  rounded-lg text-black ">
          ...
          <form  className="space-y-2 ">
            ...
            <div className={`space-y-2 `}>
            <label htmlFor="carType" className=" text-md font-semibold flex justify-start items-center lg:gap-x-[5px]">
               <p>Faults</p> 
            ...
            <button
              ...
              className={`w-full py-1 mt-4 bg-amber-400  text-black font-medium rounded transition-colors   ${formData.carNumber && formData.carType && formData.date ?' bg-yellow-500 hover:bg-yellow-400 hover:scale-105 cursor-pointer':'bg-gray-600' } `}
            >
               Confirm     
       </button>
