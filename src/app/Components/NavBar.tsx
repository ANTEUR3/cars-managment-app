...
const NavBar = (props: Props) => {
  return (
    <div className="lg:px-[130px]  lg:flex lg:justify-between lg:items-center fixed w-full bg-white z-10 ">
        <div className='lg:flex lg:justify-start lg:items-center lg:gap-x-[-4px]'>
      
        <Image src={logo} alt=' ' className='lg:w-[70px] lg:h-[70px]' />
        <h1 className='lg:font-semibold lg:text-xl text-black '>Omran Cars</h1>
        </div>
       ...
       <div className="lg:flex lg:justify-end lg:items-center lg:gap-x-[20px]">
            ...
            <Link href={''} className="lg:font-semibold lg:text-xl text-black  hover:text-yellow-500 cursor-pointer">Sales</Link >
